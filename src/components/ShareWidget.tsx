  ...
  return (
    <div className="fixed left-6 top-1/2 -translate-y-1/2 z-[60] flex flex-col items-center gap-3">
      ...
      <motion.button
        ...
        className="w-14 h-14 bg-[#1E4D92] dark:bg-[#4B9CD3] hover:bg-[#1A1A1A] dark:hover:bg-white rounded-full shadow-2xl flex items-center justify-center text-white dark:text-gray-900 transition-all relative"
        aria-label="Share"
